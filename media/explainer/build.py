...
out/plaintext-explainer.mp4 (1920x1080 H.264 + AAC, fade in/out),
out/plaintext-explainer.srt and out/poster.jpg.
"""
...
def main():
    ...
    mp4 = os.path.join(out, "plaintext-explainer.mp4")
    ...
    with open(os.path.join(out, "plaintext-explainer.srt"), "w") as f:
